...
export const SCHEDULE: Day[] = [
  {
    ...
    hours: [
      ...
      { t: "Dusk", what: "Arrive and hike in", note: "Physical work, usually in the last light. It's meant to feel like entering the unknown.", still: "fire-circle-2003", mark: true },
      ...
      { t: "Night", what: "Build camp", note: "Each team builds its own shelter with tools, tarps and rope. The first place leadership shows up.", still: "axe" },
  ...
  },
  {
    ...
    hours: [
      ...
      { t: "10:00 am", what: "The Quests", note: "Challenge stations in the forest and at the water: nerve, strength, wits, always as a team. Safety men at every station.", still: "kayaks", mark: true },
      { t: "1:00 pm", what: "Lunch at the stations" },
      { t: "2:00 pm", what: "The Quests continue" },
      { t: "4:00 pm", what: "Time off", note: "The summer-camp part. Water, games, camaraderie, tired legs.", still: "creek-team" },
  ...
  },
  {
    ...
    hours: [
      ...
      { t: "10:00 am", what: "Future Plans and acknowledgments", note: "Each young man writes what he's claiming and where he's going. His shadows tell him what they saw all weekend, and give him something to keep.", still: "hands-raised", mark: true },
      { t: "11:00 am", what: "Young men versus the men", note: "Handball meets British Bulldog. Wild, rowdy, and the men have been waiting since Friday.", still: "men-truck" },
