...
export const SCHEDULE: Day[] = [
  {
    ...
    hours: [
      ...
      { t: "Afternoon", what: "Bus: Langley", note: "McDonald's, 20394 88 Ave. Packed lunch, water bottle, sleeping bag, no phone.", mark: true },
      { t: "Afternoon", what: "Bus: Burnaby", note: "Christine Sinclair Community Centre, south lot, 3713 Kensington Ave." },
  ...
  },
  {
    ...
    hours: [
      ...
      { t: "10:00 am", what: "The Quests", note: "Challenge stations in the forest and at the water: nerve, strength, wits, always as a team. Safety men at every station.", still: "creek-quest", mark: true },
      { t: "1:00 pm", what: "Lunch at the stations" },
      { t: "2:00 pm", what: "The Quests continue" },
      { t: "4:00 pm", what: "Time off", note: "The summer-camp part. Water, games, camaraderie, tired legs.", still: "run-lake" },
  ...
  },
  {
    ...
    hours: [
      ...
      { t: "Afternoon", what: "The bus goes south", note: "Pick him up in Burnaby or Langley; times are emailed before the weekend. The men text as the bus gets close." },
