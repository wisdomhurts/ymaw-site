...
export const STILLS: Record<string, Still> = {
  ...
  "kayak-lake": { id: "kayak-lake", src: `${S}/kayak-lake.webp`, srcSmall: `${S}/kayak-lake-m.webp`, alt: "One kayak paddles out onto wide grey water under the mountains", stage: "ordinary", year: 2025 },
  ...
  "fire-circle-lake": { id: "fire-circle-lake", src: `${G}/stills/p-y2019-0231.webp`, srcSmall: `${G}/stills/p-y2019-0231-m.webp`, alt: "Dusk. Everyone in a circle around the fire pit by the water, mountains behind", stage: "ordeal", year: 2019 },
  ...
  "lake-watch": { id: "lake-watch", src: `${G}/stills/p-ymawphotos-0030.webp`, srcSmall: `${G}/stills/p-ymawphotos-0030-m.webp`, alt: "A man and a young man at the water's edge, looking out", stage: "return" },
  "arms-up-lake": { id: "arms-up-lake", src: `${G}/stills/p-ymawphotos-0109.webp`, srcSmall: `${G}/stills/p-ymawphotos-0109-m.webp`, alt: "The whole weekend at the water, every arm up", stage: "return" },
  "men-shore": { id: "men-shore", src: `${G}/stills/p-y2019-0216.webp`, srcSmall: `${G}/stills/p-y2019-0216-m.webp`, alt: "The production men in a line at the shore", stage: "men", year: 2019 },
  ...
  "driftwood-fire": { id: "driftwood-fire", src: `${G}/stills/p-y2019-0166.webp`, srcSmall: `${G}/stills/p-y2019-0166-m.webp`, alt: "The driftwood fire pit on the shore", stage: "camp", year: 2019 },
  ...
  "swim": { id: "swim", src: `${G}/stills/p-ymawphotos-0095.webp`, srcSmall: `${G}/stills/p-ymawphotos-0095-m.webp`, alt: "Young men wading into the turquoise water", stage: "trials" },
  ...
  "misty-shore": { id: "misty-shore", src: `${G}/stills/p-y2019-0003.webp`, srcSmall: `${G}/stills/p-y2019-0003-m.webp`, alt: "Figures at the misty shore under the trees", stage: "ordinary", year: 2019 },
  "beach-fire-smoke": { id: "beach-fire-smoke", src: `${G}/stills/p-y2019-0022.webp`, srcSmall: `${G}/stills/p-y2019-0022-m.webp`, alt: "Smoke from the beach fire, the whole camp by the water", stage: "ordeal", year: 2019 },
  "kayak-grey": { id: "kayak-grey", src: `${G}/stills/p-y2019-0183.webp`, srcSmall: `${G}/stills/p-y2019-0183-m.webp`, alt: "A kayak on the grey water", stage: "trials", year: 2019 },
  "raft": { id: "raft", src: `${G}/stills/p-ymawphotos-0008.webp`, srcSmall: `${G}/stills/p-ymawphotos-0008-m.webp`, alt: "Two young men poling a raft across the water", stage: "trials" },
  "run-lake": { id: "run-lake", src: `${G}/stills/p-ymawphotos-0073.webp`, srcSmall: `${G}/stills/p-ymawphotos-0073-m.webp`, alt: "Two young men running into the water", stage: "trials" },
  "group-2019": { id: "group-2019", src: `${G}/stills/p-y2019-0300.webp`, srcSmall: `${G}/stills/p-y2019-0300-m.webp`, alt: "The 2019 weekend, everyone, at the water", stage: "return", year: 2019 },
  ...
  "raft-2003": { id: "raft-2003", src: `${G}/stills/p-extra-0084.webp`, srcSmall: `${G}/stills/p-extra-0084-m.webp`, alt: "Two young men pole a raft they built across the water, 2003", stage: "trials", year: 2003 },
  ...
  "inukshuk-2006": { id: "inukshuk-2006", src: `${G}/stills/p-y2006-0087.webp`, srcSmall: `${G}/stills/p-y2006-0087-m.webp`, alt: "Building the inukshuk on the rocks above the water, 2006", stage: "reward", year: 2006 },
  ...
  "pole-frame-2006": { id: "pole-frame-2006", src: `${G}/stills/p-y2006-0208.webp`, srcSmall: `${G}/stills/p-y2006-0208-m.webp`, alt: "Raising the pole frame at the shore, 2006", stage: "camp", year: 2006 },
  "dusk-circle-2006": { id: "dusk-circle-2006", src: `${G}/stills/p-y2006-0244.webp`, srcSmall: `${G}/stills/p-y2006-0244-m.webp`, alt: "The circle at dusk by the water, 2006", stage: "ordeal", year: 2006 },
  ...
  "barge-2007": { id: "barge-2007", src: `${G}/stills/p-y2007-0086.webp`, srcSmall: `${G}/stills/p-y2007-0086-m.webp`, alt: "The barge at the shore, 2007", stage: "camp", year: 2007 },
  ...
  "everyone-2007": { id: "everyone-2007", src: `${G}/stills/p-y2007-0393.webp`, srcSmall: `${G}/stills/p-y2007-0393-m.webp`, alt: "Everyone at the water, 2007", stage: "return", year: 2007, faces: true },
...
export const CLIPS: Record<string, Clip> = {
  leg1: { id: "leg1", src: `${C}/leg1.mp4`, poster: `${S}/kayak-lake.webp`, alt: "Slow drift over the water at dusk", stage: "ordinary", seconds: 8 },
  ...
  "drone-lake": { id: "drone-lake", src: `${G}/clips/c-0139.mp4`, poster: `${G}/posters/c-0139.webp`, alt: "Drone over the water and the forest", stage: "ordinary", year: 2022, seconds: 9 },
  ...
  "drone-kayaks": { id: "drone-kayaks", src: `${G}/clips/c-0134.mp4`, poster: `${G}/posters/c-0134.webp`, alt: "Drone over kayaks on the turquoise water", stage: "trials", year: 2022, seconds: 9 },
