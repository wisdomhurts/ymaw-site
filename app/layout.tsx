...
export const metadata: Metadata = {
  ...
  description: `Not a summer camp. A rite of passage. Three days of fire, water and real work in the Squamish wilderness for young men aged 12–17, with men who have shown up for young men since 1990. ${FACTS.dates.label}. $${FACTS.priceCAD} CAD.`,
  openGraph: {
    ...
    url: SITE,
    siteName: "YMAW",
    images: [{ url: "/media/stills/hands-raised.webp", width: 1800, height: 1200, alt: "Every hand raised at the water" }],
    locale: "en_CA",
    type: "website",
  },
