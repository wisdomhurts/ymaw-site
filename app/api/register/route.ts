...
export async function POST(req: Request) {
  ...
  if (d.role === "young_man") {
    ...
    row = {
      ...
      shirt_size: y.shirt_size, pickup: y.pickup, dropoff: y.dropoff,
      ...
      release_to_name: y.release_to_name, release_to_phone: y.release_to_phone,
      release_to2_name: y.release_to2_name || null, release_to2_phone: y.release_to2_phone || null,
