...
const QA: [string, string, string][] = [
  ["Readiness", "Is my son ready for this?", "If he's 11 to 18 and you're asking, probably. The weekend is built for young men who've never done anything like it, and for ones who have. He doesn't need to be outdoorsy, athletic, or confident. He needs to be willing to get on the bus. The men take it from there. If he's anxious, that's normal; most are. Read His Path with him."],
