...
const QA: [string, string, string][] = [
  ...
  ["Getting there", "Where is it, exactly?", "A new site for 2027, in the BC wilderness. The exact location isn't published. The bus leaves Friday afternoon from Langley (McDonald's, 20394 88 Ave) and Burnaby (Christine Sinclair Community Centre, south lot), and returns Sunday afternoon to the same stops. Times are emailed before the weekend. Coming from elsewhere? Email us and we'll sort the ride."],
  ...
  ["Coming back", "Can he come again next year?", "Yes, and most do. The programme is built new every year \u2014 different Quests, a different theme, different work, different men shadowing him. Young men often come four or five years running, and each weekend is a different one. What changes as he comes back is what the men ask of him: at twelve he is carried a little, and by sixteen he is the one steadying the younger ones. Then the ones who keep coming turn eighteen and join the team."],
  ["After", "What happens after?", "He comes home tired and, often, different. The Society hosts gatherings for the men through the year. Many families come back the next year; many fathers end up on the team. Ask at the bus stop."],
];
