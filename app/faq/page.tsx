...
const QA: [string, string, string][] = [
  ...
  ["Money", `What does $${FACTS.priceCAD} cover?`, "Everything. The bus from Langley or Burnaby and back, eight meals, tools and gear for camp, the Quests, his shirt, and fifty volunteers' weekend. Nobody is paid. The fee covers costs and nothing else. It's non-refundable unless the weekend is cancelled."],
  ...
  ["Faith", "Is it religious?", "No. It's non-denominational. There's no creed. There are four values (responsibility, integrity, community, self-discovery) and the men hold themselves to a code. Families of every faith and none send young men."],
  ["Pictures", "Will he be photographed?", "Only as you choose at registration: yes; only where he isn't identifiable; or not at all. Everything on this website was taken at a real weekend, with that choice respected. The circle and the ceremony are never filmed."],
